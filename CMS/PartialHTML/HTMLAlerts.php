<?php
    ...
    class HTMLAlerts
    {
        ...
        public static function GetHTMLAlert($message, $alertType = BootstrapAlertType::DANGER){
            return '<div class="'.$alertType.'" role="alert">' . $message . '</div>';
        }

        public static function GetHTMLAlertWCloseButton($message, $alertType = BootstrapAlertType::DANGER){
        ...
        public static function GetHTMLAlertWHeader($headerMessage, $message, $alertType = BootstrapAlertType::DANGER){
            return '<div class="' . $alertType . '" role="alert"><h4 class="alert-heading">' . $headerMessage . '</h4><hr><p>' . $message . '</p></div>';
        }

        public static function GetHTMLAlertWHeaderAndCloseButton($headerMessage, $message, $alertType = BootstrapAlertType::DANGER){
